...
import {
  ...
  SidebarProps,
  NavSubItemProps,
} from "../constants/interfaces/sidebar";
...
const NavItem = ({ icon, arrowIcon, label, active, onClick }: NavItemProps) => (
  <HStack
    gap="0.75rem"
    w="100%"
    py="0.75rem"
...
const NavSubItem = ({ icon, label, active, onClick }: NavSubItemProps) => (
  <HStack
    w="100%"
    py="0.5rem"
    pl="1rem"
