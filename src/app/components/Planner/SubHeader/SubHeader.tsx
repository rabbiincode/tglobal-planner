...
export const SubHeader = () => {
  ...
  const activeBg = (isActive: boolean, btn: "live" | "planner") =>
    isActive ? BG_LOOKUP[btn] : "white";
  const activeColor = (isActive: boolean) =>
    isActive ? "white" : "brandToggleText";
  ...
  return (
    <Box w="full">
      <HStack
        ...
        borderWidth="1px"
        borderColor={
          view === "live" ? "brandErrorBorder" : "brandSecondaryBorder"
        }
      ...
      >
        <Box rounded="full" bg="white" p="1">
          <ButtonGroup gap={0} rounded="full" border="none">
            <Button
