...
export default function CreateRosterModal({ isOpen, onClose }: Props) {
            ...
            <VStack gap={5} align="stretch">
              ...
              <Field.Root>
                ...
                >
                  ...
                  <option>Behandelingkamer1</option>
                  <option>Behandelingkamer2</option>
                </select>
              </Field.Root>
